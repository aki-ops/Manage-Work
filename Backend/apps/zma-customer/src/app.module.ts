...
import { CompanyMutation, UserMutation } from './controllers/mutations';
import { CompanyResolver, MasterDataResolver, UserResolver } from './controllers/resolvers';
        ...
        transports: [
          new winston.transports.Console({
            format: winston.format.combine(
              ...
              winston.format.ms(),
              nestWinstonModuleUtilities.format.nestLike('zma-customer', {
                colors: true,
                prettyPrint: true,
              }),
            ),
