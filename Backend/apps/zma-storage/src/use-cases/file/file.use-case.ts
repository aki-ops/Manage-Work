...
import { StorageServiceConfirmUploadedFilesGqlInput } from '@passiontech-nestjs-template/zma-types/inputs/storage';
import { ConfirmUploadedFilesOutput } from '@passiontech-nestjs-template/zma-types/outputs/storage';
import { FileUtils, IdUtils } from '@passiontech-nestjs-template/zma-utils';
